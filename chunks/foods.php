				...
				<div class="card">
				    ...
				    <div class="card-content">
						<span class="card-title activator grey-text text-darken-4"><a class="black-text" href=""><?php echo $arr_all[$i+$j-2]['fname']; ?></a><i class="material-icons right">more_vert</i></span>
							...
							<a  class="btn waves-effect waves-block waves-light" href="backends/order-food.php"  style="background: #ee6e73"; onclick="addCart(<?php echo $arr_all[$i+$j-2]['id'];?>)">Add to cart</a></div>
						</div>
